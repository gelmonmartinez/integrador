 ...
 */
public class ModeloTablaTrapecioMultiple extends AbstractTableModel {

    private ArrayList<FilaTrapecioMultiple> lista = new ArrayList<FilaTrapecioMultiple>();
    private String[] columnas = {"i", "h", "a+ih", "f(a+ih)"};

    public ModeloTablaTrapecioMultiple(ArrayList<FilaTrapecioMultiple> lista) {
        this.lista = lista;
    }

    public ModeloTablaTrapecioMultiple() {
    }
